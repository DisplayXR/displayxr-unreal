...
#include "DisplayXRMaterialExpressionTopBottomCoords.h"
#include "DisplayXRMaterialExpressionStereoIndex.h"
#include "MaterialCompiler.h"

#if WITH_EDITOR
void UDisplayXRMaterialExpressionTopBottomCoord::GetCaption(TArray<FString>& OutCaptions) const
{
	OutCaptions.Add("TopBottom Coordinate");
}

int32 UDisplayXRMaterialExpressionTopBottomCoord::Compile(FMaterialCompiler* Compiler, int32 OutputIndex)
{
	...
	int32 ConstDivide = Compiler->Constant2(1, 2);
	int32 ViewCoord = Compiler->Div(CoordVec2, ConstDivide);
	int32 ConstMultiply = Compiler->Constant2(0, 0.5f);
